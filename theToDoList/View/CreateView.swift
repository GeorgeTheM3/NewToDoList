...
class CreateView: UIView {
    ...
    private func nameLabelConstraints() {
        ...
        nameLabel.bottomAnchor.constraint(equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: -515).isActive = true
        nameLabel.leftAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leftAnchor, constant: 65).isActive = true
    }
    private func textFieldNameConstraints() {
        textFieldName.heightAnchor.constraint(equalToConstant: 50).isActive = true
        textFieldName.rightAnchor.constraint(equalTo: self.safeAreaLayoutGuide.rightAnchor, constant: -61).isActive = true
        textFieldName.bottomAnchor.constraint(equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: -465).isActive = true
        textFieldName.leftAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leftAnchor, constant: 65).isActive = true
    }
    private func passwordLabelConstraints() {
        passwordLabel.heightAnchor.constraint(equalToConstant: 20).isActive = true
        passwordLabel.bottomAnchor.constraint(equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: -422).isActive = true
        passwordLabel.leftAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leftAnchor, constant: 65).isActive = true
    }
    private func textFieldPasswordConstraints() {
        textFieldPassword.heightAnchor.constraint(equalToConstant: 50).isActive = true
        textFieldPassword.rightAnchor.constraint(equalTo: self.safeAreaLayoutGuide.rightAnchor, constant: -61).isActive = true
        textFieldPassword.bottomAnchor.constraint(equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: -372).isActive = true
        textFieldPassword.leftAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leftAnchor, constant: 65).isActive = true
    }
    private func signUpButtonConstraints() {
        signUpButton.heightAnchor.constraint(equalToConstant: 42).isActive = true
        signUpButton.rightAnchor.constraint(equalTo: self.safeAreaLayoutGuide.rightAnchor, constant: -120).isActive = true
        signUpButton.bottomAnchor.constraint(equalTo: self.safeAreaLayoutGuide.bottomAnchor, constant: -50).isActive = true
        signUpButton.leftAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leftAnchor, constant: 120).isActive = true
    }
